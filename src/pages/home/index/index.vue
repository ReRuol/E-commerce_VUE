...
<style scoped>
    ...
    .quick-nav{width:100%;height:1.6rem;background-color:#FFFFFF;margin-top:0.4rem;display: flex;align-items: center;justify-content: space-between;padding:0px 0.2rem;box-sizing: border-box;}
    ...
    .goods-recom .goods-list .goods-title{width:100%;height:0.8rem;overflow:hidden;font-size:0.28rem;margin-top:0.1rem;padding:0 0.1rem}
    .goods-recom .goods-list .goods-price{width:auto;height:auto;font-size:0.32rem;color:#d32a4e;margin-top:0.1rem;padding:0 0.1rem}
</style>
